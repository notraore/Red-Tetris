...
<div class="demoPage">
    <section>
        <div class="grid">
            <div class="col-6_xs-12">
                ...
                <p>Based on <a href="http://dev.w3.org/csswg/css-flexbox/">Flexbox</a> (<em>CSS Flexible Box Layout
                    Module</em>), <strong>Gridlex</strong> is a very simple css grid system to quickly create modern
                    layouts and submodules.</p>
            </div>
            <div class="col-5_xs-12-bottom github-button" data-push-left="off-1_xs-0">
                <a class="github-button" href="https://github.com/devlint/gridlex" data-size="large"
                   data-count-href="/devlint/gridlex/stargazers" data-show-count="true"
                   data-count-aria-label="# stargazers on GitHub" aria-label="Star devlint/gridlex on GitHub">View
                    Project Source</a> <a class="github-button" href="https://github.com/devlint/gridlex/fork"
                                          data-size="large" data-count-href="/devlint/gridlex/network"
                                          data-show-count="true" data-count-aria-label="# forks on GitHub"
                                          aria-label="Fork devlint/gridlex on GitHub">Fork Gridlex</a> <a
                    class="github-button" href="https://github.com/devlint/gridlex/archive/master.zip" data-size="large"
                    aria-label="Download devlint/gridlex on GitHub">Download (zip)</a>
            </div>
            ...
            <div class="col-12">
                ...
                <pre class="doc"><code>&lt;link rel="stylesheet" href="<a
                        href="https://cdnjs.cloudflare.com/ajax/libs/gridlex/2.7.1/gridlex.min.css">https://cdnjs.cloudflare.com/ajax/libs/gridlex/2.7.1/gridlex.min.css</a>"></code></pre>
    ...
    <section>
        ...
        <p><strong>This feature is so simple, but we find it very very rarely in a robust and flexible grid!</strong>
            <br> Why should we be required to put sizing classes on every single cell when they all have the same width?
        </p>
...
&lt;/div></code></pre>
        ...
        <p>Auto width columns, no size on cells ! <br> That's a pretty cool feature of flex: the number determines the
            width (size = grid/cells children).</p>
...
&lt;/div></code></pre>
        ...
        <h2 id="complex-grid">We can also compose a complex grid:</h2>

        <div class="grid-2_md-1-equalHeight">
        ...
        <!--<div class="grid-3">
            <div class="col">
                <div class="grid-noGutter-column demo-card">
                    <div class="col">
                        <img src="https://images.unsplash.com/photo-1445964047600-cdbdb873673d?fit=crop&fm=jpg&h=375&w=500" alt="Placeholder image">
                    </div>
                    <div class="col grid-column">
                        <div class="col grid">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi asperiores dolorem doloremque eligendi fugiat odio quia repellat ut vel. Accusantium at iusto mollitia quas tempora. </p>
                        </div>
                        <div class="col grid-noGutter demo-card-footer">
                            <div class="col"><a href="#">Link</a></div>
                            <div class="col"><a href="#">Link</a></div>
                            <div class="col"><a href="#">Link</a></div>
                        </div>
                    </div>
        ...
        <div class="grid-equalHeight_md-1">
            <div class="col-5_md-12_md-first">
                <div class="demo demo-left">
                    <p><strong>Tall box</strong><br>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam semper diam at erat pulvinar, at
                        pulvinar felis blandit. Vestibulum volutpat tellus diam, consequat gravida libero rhoncus ut.
        ...
        <pre><code>&lt;div class="col-12 lg-hidden">&lt;/div>
&lt;div class="col-12 md-hidden">&lt;/div>
&lt;div class="col-12 sm-hidden">&lt;/div>
&lt;div class="col-12 xs-hidden">&lt;/div></code></pre>
    </section>
...
&lt;/div></code></pre>
  ...
  -0: reboot the offset (can be usefull in responsive mode with key-suffixes)</code></pre>
        ...
        <h3>Because of responsive, you need sometimes to change the size of columns: with these keys as classes you can
            control your layout by media-queries.</h3>
    ...
    <section class="doc">
        ...
        <h2>Variables</h2>
        <div class="bs-callout">
            <p>So that <strong>Gridlex</strong> fits into your workflow, you can import it and override the next
                variables:</p>
            <table>
                <thead>
                <tr>
  ...
  xs: 36em
    ...
    <section id="caniuse">
        ...
        <p class="ciu_embed" data-feature="flexbox" data-periods="future_1,current,past_1,past_2">
            <a href="http://caniuse.com/#feat=flexbox">Can I Use flexbox?</a> Data on support for the flexbox feature
            across the major browsers from caniuse.com. </p>
    </section>
...
<footer>
    ...
    <p>With awesome contributors : <a href="https://github.com/vlsoprun">@vlsoprun</a> - <a
            href="https://github.com/sconstantinides">@sconstantinides</a> - <a href="https://github.com/TheKidCoder">@TheKidCoder</a>
        - <a href="https://github.com/bryanwillis">@bryanwillis</a> - <a href="https://github.com/ixrock">@ixrock</a>
    </p>
</footer>
